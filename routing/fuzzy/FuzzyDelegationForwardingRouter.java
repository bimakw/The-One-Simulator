...
public class FuzzyDelegationForwardingRouter implements RoutingDecisionEngine{
    ...
    public FuzzyDelegationForwardingRouter(FuzzyDelegationForwardingRouter prototype){
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost) {
        ...
        if (this.getTOUValueFor(m.getTo()) < peer.getTOUValueFor(m.getTo())) {
            if (utilityValue < peer.getTOUValueFor(m.getTo())) {
                utilityValue = peer.getTOUValueFor(m.getTo());
