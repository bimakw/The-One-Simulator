...
public class SimBetDynamicAlpha implements RoutingDecisionEngine, SimilarityDetectionEngine {
    ...
    public SimBetDynamicAlpha(Settings s) {
    ...
    public SimBetDynamicAlpha(SimBetDynamicAlpha proto) {
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        SimBetDynamicAlpha de = this.getOtherDecisionEngine(peer);
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost) {
        ...
        SimBetDynamicAlpha de = getOtherDecisionEngine(otherHost);
    ...
    protected double countSimBetUtil(double simPeerForDest, double betweennessPeer, double mySimForDest, double myBetweenness ){
        ...
        double a;
//        System.out.println("Similarity of Source : "+mySimForDest);
...
//        System.out.println("Dest  SimUtil"+simPeerForDest);
        ...
        a = countAlpha(simUtilForDest, simPeerForDest,betUtil,betutilpeer);
...
private double countAlpha(double simUtilForDest, double simUtilPeerForDest, double betUtil, double betutilpeer) {
		if(simUtilForDest>simUtilPeerForDest) {
			double simdiff=simUtilForDest-simUtilPeerForDest;
			if(simdiff==treshold) {
				this.a=simUtilForDest+treshold;
    ...
    */
    ...
    private SimBetDynamicAlpha getOtherDecisionEngine(DTNHost otherHost) {
        MessageRouter otherRouter = otherHost.getRouter();
        assert otherRouter instanceof DecisionEngineRouter : "This router only works "
                + " with other routers of same type";

        return (SimBetDynamicAlpha) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
    }
    ...
    public RoutingDecisionEngine replicate() {
        return new SimBetDynamicAlpha(this);
    }
